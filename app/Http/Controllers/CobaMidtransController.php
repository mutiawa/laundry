...
class CobaMidtransController extends Controller
{
    ...
    public function cekstatus2(){
        ...
        for($i=0; $i<count($id); $i++){
            ...
            // simpan data
            $empData = ['no_transaksi' => $no_transaksi, 'tgl_bayar' => $outputjson['transaction_time'], 'bukti_bayar' => 'midtrans-logo.png', 'jenis_pembayaran' => 'pg', 'status' => 'approved', 'tgl_konfirmasi' => now()];
