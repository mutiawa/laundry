        ...
        <form action="{{ route('pegawai.store') }}" method="post">
          ...
          <fieldset disabled>
            <div class="mb-3"><label for="kodepegawailabel">Kode pegawai</label>
              <input class="form-control form-control-solid" id="kode_pegawai_tampil" name="kode_pegawai_tampil" type="text" placeholder="PR-001" value="{{$kode_pegawai}}" readonly>
            </div>
          </fieldset>
          ...
          <div class="mb-3"><label for="namapegawailabel">Nama pegawai</label>
            <input class="form-control form-control-solid" id="nama_pegawai" name="nama_pegawai" type="text" placeholder="Masukan Nama Kamu">
          </div>
          ...
          <div class="mb-3">
            ...
            <select class="form-control form-control-solid" id="jenis_kelamin_pegawai" name="jenis_kelamin_pegawai">
              <option value="Laki-laki" {{ old('jenis_kelamin_pegawai') == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
              <option value="Perempuan" {{ old('jenis_kelamin_pegawai') == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
            </select>
          </div>


          <div class="mb-3"><label for="nohplabel">Nomor HP</label>
            <input class="form-control form-control-solid" id="no_telp_pegawai" name="no_telp_pegawai" type="number" placeholder="081234567890" value="{{old('no_telp_pegawai')}}">
          </div>
