                    ...
                    <form action="{{ route('bahanbaku.update', $bahanbaku->id) }}" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control form-control-solid" id="bahanbaku_jenis" name="bahanbaku_jenis">
                                <option value="Deterjen & Pembersih"
                                    {{ old('bahanbaku_jenis') == 'Deterjen & Pembersih' ? 'selected' : '' }}>Deterjen & Pembersih
                                </option>
                                <option value="Pelembut & Pewangi"
                                    {{ old('bahanbaku_jenis') == 'Pelembut & Pewangi' ? 'selected' : '' }}>Pelembut & Pewangi
                                </option>
                                <option value="Peralatan" 
                                    {{ old('bahanbaku_jenis') == 'Peralatan' ? 'selected' : '' }}>Peralatan
                                </option>
                                <option value="Kemasan" 
                                    {{ old('bahanbaku_jenis') == 'Kemasan' ? 'selected' : '' }}>Kemasan
                                </option>
                                <option value="Bahan Pendukung"
                                    {{ old('bahanbaku_jenis') == 'Bahan Pendukung' ? 'selected' : '' }}>Bahan Pendukung
                                </option>
                                <option value="Alat Kebersihan" 
                                    {{ old('bahanbaku_jenis') == 'Alat Kebersihan' ? 'selected' : '' }}>Alat Kebersihan
                                </option>
                            </select>
                        </div>
